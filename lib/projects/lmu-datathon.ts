...
export const lmuDatathonProject: ProjectData = {
  ...
  descriptionLead: `Competed in a 4-hour datathon on EMS meal-break compliance — clean the data, estimate violations, frame a reassignment scenario. The work was workable; the durable value came from the post-mortem on scope, dependencies, and baseline-first execution.`,
  description: `The board-level question: if California meal-break requirements were enforced for 24-hour shift nurses, how often would the company be in violation, and what would reassignment do to response times? We moved fast enough to clean the data, characterize base-level operations, estimate break-violation exposure, and frame a reassignment scenario. This project gave me one of the cleanest examples of how decent instincts and real effort can still create avoidable drag when the approach is wrong.`,
  outputs: [

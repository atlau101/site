...
export const malloyAmalProject: ProjectData = {
  ...
  descriptionLead: `Evaluated whether NFC-based smart attendance could work in higher education — and concluded it couldn't. The research pointed toward senior living and hospitals instead.`,
  description: `We were hired to evaluate whether an NFC-based smart attendance system could work in universities. I built a five-pillar feasibility framework from scratch — Assessment, Stakeholders, Legal Requirements, Onboarding & Management, Platform Components — and ran it across 8+ markets. Most universities already had NFC infrastructure; the gap wasn't technology, it was adoption will blocked by policy, student privacy objections, and FERPA constraints. The same framework that eliminated the original target pointed toward markets where the privacy framing flipped entirely.`,
  outputs: [

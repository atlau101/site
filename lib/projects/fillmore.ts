...
export const fillmoreProject: ProjectData = {
  ...
  descriptionLead: `Spent a semester researching SF's Lower Fillmore after the Safeway closure created a food and pharmacy desert for ~8,700 residents. Estimated $8M+ in annual leakage and pitched a hybrid community marketplace to a panel of six SF decision-makers.`,
  description: `A move that created a food and pharmacy desert for ~8,700 residents, 17% of them seniors, with 50% of some tracts below SF's poverty line. We estimated $6.8M–$10.3M in annual grocery spend and $1.6M–$2.0M in pharmacy revenue leaking out of the neighborhood. Before ideating solutions, we walked the block, interviewed residents and local businesses (KC Paris Desserts, Sheba Jazz, Miyako's), studied the neighborhood's demographics, and researched its history as the former "Harlem of the West." We evaluated two redevelopment models via SWOT analysis and pitched our main recommendation — a hybrid Fillmore Community Marketplace — as a poster at YesSF and as a live presentation to a panel of 6 SF decision-making executives.`,
  outputs: [
    ...
    { label: 'Seed Funding Raised:', value: '$1,500' },
  ],
  visuals: [
    {
